...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({ settings, updateSettings, resetToDefault, onClose }) => {
    const [activeTab, setActiveTab] = useState<'general' | 'text' | 'layout' | 'color' | 'themes'>('general');
    ...
    return (
        ...
        >
            ...
            <div style={{ display: 'flex', marginBottom: '16px', borderBottom: '1px solid #eee' }}>
                <ButtonTab active={activeTab === 'general'} onClick={() => setActiveTab('general')} label="ทั่วไป" />
                <ButtonTab active={activeTab === 'text'} onClick={() => setActiveTab('text')} label="ข้อความ" />
                <ButtonTab active={activeTab === 'layout'} onClick={() => setActiveTab('layout')} label="เค้าโครง" />
                <ButtonTab active={activeTab === 'color'} onClick={() => setActiveTab('color')} label="สี" />
                <ButtonTab active={activeTab === 'themes'} onClick={() => setActiveTab('themes')} label="ธีม" />
            </div>
                    ...
                    <div style={{ marginBottom: '16px' }}>
                        <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                            <input
                                ...
                                onChange={(e) => updateSettings({ chnageHeaderColor: e.target.checked })}
            ...
            {activeTab === 'layout' && (
                <div>
                    <div style={{ marginBottom: '16px' }}>
                        <label style={{ display: 'block', marginBottom: '8px' }}>
                            ความกว้างเนื้อหา: {settings.contentWidth == 0 ? '100%' : settings.contentWidth + 'px'}
                        </label>
                        <InputRange
                            min={0}
                            max={3840}
                    ...
                    <div style={{ marginBottom: '16px' }}>
                        <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                            <input
                                ...
                                onChange={(e) => updateSettings({ mainCenterFullWidth: e.target.checked })}
                                style={{ marginRight: '8px' }}
                            />
            ...
            {activeTab === 'color' && (
                <div>
                    <div style={{ marginBottom: '16px' }}>
                        ...
                        >
                            {predefinedThemes.map((theme) => {
                                const isSelected =
                                    settings.backgroundColor === theme.bg && settings.textColor === theme.text;
                    ...
                    <div style={{ marginBottom: '16px' }}>
                        <label style={{ display: 'block', marginBottom: '8px' }}>สีพื้นหลัง</label>
                        <InputColor
                    ...
                    <div style={{ marginBottom: '16px' }}>
                        <label style={{ display: 'block', marginBottom: '8px' }}>สีข้อความ</label>
                        <InputColor
            ...
            {activeTab === 'themes' && (
                <ThemeManager currentSettings={settings} applySettings={(newSettings) => updateSettings(newSettings)} />
            )}
