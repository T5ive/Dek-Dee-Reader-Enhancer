...
export const App: React.FC = () => {
    ...
    useEffect(() => {
        ...
        let settingButtonWrapper = document.getElementById('dek-d-reader-settings-button') as HTMLElement;
        if (!settingButtonWrapper) {
            ...
            fontSizePopup.parentNode?.insertBefore(settingButtonWrapper, fontSizePopup.nextSibling);
        }
        ...
        root.render(<ButtonSetting btnColor={settings.textColor} onClick={toggleSettings} />);
